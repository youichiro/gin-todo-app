...
var TaskWhere = struct {
	...
	Done:      whereHelperbool{field: "\"tasks\".\"done\""},
...
var (
	taskAllColumns            = []string{"id", "title", "done", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"title"}
	taskColumnsWithDefault    = []string{"id", "done", "created_at", "updated_at"}
